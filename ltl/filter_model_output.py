...
def main():
    ...
    with open('../ltl/new_json_for_eval/prosody_transformer_multiclass_results.json', 'r') as f:
    ...
    with open('../ltl/new_json_for_eval/filtered_prosody_transformer_multiclass_results.json', 'w') as f:
