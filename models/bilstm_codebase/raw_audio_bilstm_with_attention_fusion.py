...
def test_model(model, iterator, device, num_classes):
    ...
    results_filepath = '../outputs/raw_audio_bilstm_features_results.txt'
...
def plot_metrics(train_losses, val_losses, val_accuracies, val_precisions, val_recalls, val_f1s):
    ...
    plt.tight_layout()
    metrics_filepath = '../outputs/raw_audio_bilstm_features_metrics.png'
...
def main():
    ...
    json_path = '../../prosody/data/ambiguous_raw_extracted_audio_ml_features_train_embeddings.json'
    ...
    NUM_LAYERS = 2
    DROPOUT = 0.5  # Example dropout value
    ...
    optimizer = optim.Adam(model.parameters(), 
                           lr=0.0041239120868983, #
                           weight_decay= 5.429179748230386e-06) #
    ...
    criterion = nn.CrossEntropyLoss(ignore_index=PADDING_VALUE, weight=class_weights) #weight=class_weights
    ...
    eval_json = "../../prosody/data/ambiguous_raw_extracted_audio_ml_features_eval_embeddings.json"
