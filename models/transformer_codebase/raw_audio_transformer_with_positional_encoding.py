...
def test_model(model, iterator):
    ...
    File outputs:
        - '../outputs/raw_audio_transformer_multiclass_results.txt': Detailed word-level results
    ...
    results_txt_path = '../outputs/raw_audio_transformer_multiclass_results.txt'
...
if __name__ == "__main__":
    ...
    classwise_metrics_path = os.path.join(log_dir, "raw_audio_classwise_metrics.txt")
    ...
    confusion_matrix_path = os.path.join(log_dir, "raw_audio_confusion_matrix.txt")
