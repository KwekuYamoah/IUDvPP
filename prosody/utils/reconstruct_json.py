...
if __name__ == "__main__":
    ...
    json1_path = '../prosody/data/reconstructed_extracted_features.json'
    json2_path = '../prosody/data/extracted_audio_features.json'
    ...
    output_file = '../prosody/data/prosodic_raw_acoustic_features.json'
